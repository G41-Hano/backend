# Generated by Django 5.1.7 on 2025-10-28 14:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires_at', models.DateTimeField(default=datetime.datetime(2025, 10, 28, 15, 16, 45, 666369, tzinfo=datetime.timezone.utc))),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('total_points_encrypted', models.BinaryField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('definition', models.TextField(blank=True, null=True)),
                ('answer', models.CharField(blank=True, max_length=200, null=True)),
                ('question_media', models.URLField(blank=True, max_length=500, null=True)),
                ('drill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_questions', to='api.drill')),
            ],
            options={
                'abstract': False,
