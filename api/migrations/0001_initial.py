    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires_at', models.DateTimeField(default=datetime.datetime(2025, 5, 30, 3, 57, 46, 726274, tzinfo=datetime.timezone.utc))),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('M', 'Multiple Choice'), ('D', 'Drag and Drop'), ('F', 'Fill in the Blank'), ('G', 'Memory Game'), ('P', 'Picture Word')], default='M', max_length=1)),
                ...
                ('dropZones', models.JSONField(blank=True, default=list, null=True)),
                ...
                ('story_title', models.CharField(blank=True, max_length=100, null=True)),
